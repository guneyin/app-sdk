...
func (c *notificationServiceClient) SendNotification(ctx context.Context, in *NotificationServiceRequest, opts ...grpc.CallOption) (*Empty, error) {
...
func _NotificationService_SendNotification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NotificationServiceRequest)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationServiceServer).SendNotification(ctx, req.(*NotificationServiceRequest))
	}
